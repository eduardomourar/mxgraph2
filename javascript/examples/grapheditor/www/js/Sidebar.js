...
Sidebar.prototype.addMiscPalette = function(expand)
{
	var fns = [
		...
		this.createVertexTemplateEntry('text;html=1;strokeColor=#c0c0c0;overflow=fill;', 180, 140,
	 	...
	 	this.createVertexTemplateEntry('html=1;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 120, 60, 'RECTANGLE', 'Comic Rectangle', true, null, 'comic rectangle rect box text retro'),
	 	this.createVertexTemplateEntry('rhombus;html=1;align=center;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 100, 100, 'DIAMOND', 'Comic Diamond', true, null, 'comic diamond rhombus if condition decision conditional question test retro'),
	 	this.createVertexTemplateEntry('shape=hexagon;align=center;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 120, 60, 'HEXAGON', 'Comic Hexagon', true, null, 'comic hexagon preparation retro'),
	 	this.createVertexTemplateEntry('shape=parallelogram;align=center;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 140, 60, 'PARALLELOGRAM', 'Comic Parallelogram', true, null, 'comic parallelograph data retro'),
	 	this.createVertexTemplateEntry('shape=trapezoid;align=center;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 120, 60, 'TRAPEZOID', 'Comic Trapezoid', true, null, 'comic trapezoid retro'),
	 	this.createVertexTemplateEntry('shape=step;html=1;align=center;whiteSpace=wrap;rounded=0;comic=1;strokeWidth=2;fontFamily=Comic Sans MS;fontStyle=1;', 120, 60, 'STEP', 'Comic Step', true, null, 'comic step retro'),
