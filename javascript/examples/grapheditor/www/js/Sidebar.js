...
Sidebar.prototype.addMiscPalette = function(expand)
{
	...
	var fns = [
		...
		{
			return sb.createVertexTemplateFromData('', 180, 120, 'Table 1');
		}),
		this.addEntry('table', function()
		{
			return sb.createVertexTemplateFromData('', 180, 120, 'Table 2');
		}),
		this.addEntry('table title', function()
		{
			return sb.createVertexTemplateFromData('', 180, 120, 'Table with Title 1');
		}),
		this.addEntry('table title', function()
		{
			return sb.createVertexTemplateFromData('', 180, 150, 'Table with Title 2');
		}),
		this.addEntry('crossfunctional cross-functional cross functional flowchart swimlane table', function()
		{
			return sb.createVertexTemplateFromData('', 400, 400, 'Cross-Functional Flowchart');
		}),
